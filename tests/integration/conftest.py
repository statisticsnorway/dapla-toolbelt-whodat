...
def setup() -> Generator[None, None, None]:
    ...
    os.environ["WHODAT_SERVICE_URL"] = "http://localhost:9191"
    ...
    if os.environ.get("GITHUB_ACTIONS") != "true":
        ...
        os.environ["WHODAT_SERVICE_AUTH_TOKEN"] = id_token
        yield
        # Teardown step
        os.unsetenv("WHODAT_SERVICE_URL")
        os.unsetenv("WHODAT_SERVICE_AUTH_TOKEN")
    else:
